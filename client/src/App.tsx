...
import { GeneralLedgerProvider } from './modules/general-ledger/context/GeneralLedgerContext';
import GeneralLedgerPage from './modules/general-ledger/pages/GeneralLedgerPage';

// Financial Management module (AP/AR)
import { FinancialManagementProvider } from './modules/financial-management/context/FinancialManagementContext';
import FinancialManagementPage from './modules/financial-management/pages/FinancialManagementPage';

// Payroll Management module
import { PayrollProvider } from './modules/payroll-management/context/PayrollContext';
import PayrollPage from './modules/payroll-management/pages/PayrollPage';

// Budgeting & Forecasting module
import BudgetingPage from './modules/budgeting/pages/BudgetingPage';
...
function AppContent() {
  ...
  const renderActiveView = () => {
    switch (pathname) {
      ...
      // ─── Financial Management (AP/AR) routes ─────────────
