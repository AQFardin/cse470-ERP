...
export default function InventoryItemsView() {
  ...
  async function createInventoryItem(
    ...
    if (!inventoryId || !variantId) {
      alert("Please select an inventory and variant.");
      return;
    }
  ...
  function inventoryLabel(inventoryId: string) {
    const item = items.find(
      (i) => i.inventoryId === inventoryId
    );

    return warehouseName(item?.inventory?.warehouseId);
  }
