...
export default function Sidebar({ 
  ...
  const navItems = [
    ...
    { name: 'General Ledger', path: '/general-ledger', icon: BookOpen, show: hasPermission('general_ledger', 'view_chart_of_accounts') || hasPermission('general_ledger', 'view_journal') },
    { name: 'Financial Mgmt (AP/AR)', path: '/financial-management', icon: Landmark, show: hasPermission('ap', 'view') || hasPermission('ap', 'view_reports') || hasPermission('ar', 'view') || hasPermission('ar', 'view_reports') },
    { name: 'Payroll', path: '/payroll', icon: Banknote, show: hasPermission('payroll', 'view') || hasPermission('payroll', 'view_reports') || hasPermission('payroll', 'view_payslip') },
    { name: 'Budgeting', path: '/budgeting', icon: PiggyBank, show: hasPermission('budget', 'view') || hasPermission('budget', 'view_reports') || hasPermission('budget', 'view_forecast') },
    { name: 'Compliance & Tax', path: '/compliance', icon: ShieldCheck, show: hasPermission('compliance', 'view_compliance') || hasPermission('compliance', 'view_tax_reports') },
