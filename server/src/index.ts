...
import apRoutes from '../modules/financial-management/routes/ap.routes';
import arRoutes from '../modules/financial-management/routes/ar.routes';
import payrollRoutes from '../modules/payroll-management/routes/payroll.routes';
import budgetingRoutes from '../modules/budgeting/routes/budgeting.routes';
import complianceRoutes from '../modules/compliance/routes/compliance.routes';
import notificationRoutes from './routes/notifications';
import { startNotificationSweep } from './lib/notificationSweep';
...
app.listen(PORT, () => {
  ...
  console.log(`   General Ledger:   http://localhost:${PORT}/api/general-ledger`);
  console.log(`   Accounts Payable: http://localhost:${PORT}/api/ap`);
  console.log(`   Accounts Receivable: http://localhost:${PORT}/api/ar`);
  console.log(`   Payroll:          http://localhost:${PORT}/api/payroll`);
  console.log(`   Budgeting:        http://localhost:${PORT}/api/budgeting`);
  console.log(`   Compliance & Tax: http://localhost:${PORT}/api/compliance`);
